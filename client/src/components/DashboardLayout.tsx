...
function DashboardContent({ children }: { children: React.ReactNode }) {
  ...
  const active = visibleItems.find(item => item.path === location) ?? (location.startsWith("/department-schedules") ? { label: "Task schedules" } : location.startsWith("/tasks") ? { label: "WhatsApp tasks" } : { label: "Hospital Operations" });
