...
vi.mock("@/lib/trpc", () => ({
  trpc: { operations: { calendar: { useQuery: () => ({ isLoading: false, data: { tasks: [], maintenance: [], expiry: [], duties: [], risks: [{ id: 1, title: "Review oxygen-risk mitigation", date: new Date("2026-08-21"), departmentName: "Emergency", status: "open" }], managementActions: [{ id: 2, title: "Verify crash-cart seal", date: new Date("2026-08-22"), departmentName: "Emergency", status: "open" }] } }) } } },
}));
