...
- [x] Use the existing automatic operational cycle, standardize WhatsApp task timing to Asia/Kathmandu, and preserve Housekeeping and Housekeeping/Infection Control as separate departments.
...
- [x] Implement fair configurable scoring that separates manager non-distribution, department outcomes, exceptions, cancellations, reschedules, direct completion, and escalation without false department penalties.
...
- [x] Enhance task schedule configuration, task-specific due/grace/escalation/evidence/verification settings, priority, categories, scorecards, monthly trends, and meeting-ready reporting.
